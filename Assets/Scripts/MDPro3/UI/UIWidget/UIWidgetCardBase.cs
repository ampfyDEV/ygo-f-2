...
namespace MDPro3.UI
{
    public class UIWidgetCardBase : UIWidget
    {
        ...
        private const string LABEL_TXT_CARD_NUM_VALUE = "CardArea/TextCardNumValue";
        ...
        protected TextMeshProUGUI TextCardNumValue =>
            ...
            : Manager.GetNestedElement<TextMeshProUGUI>(LABEL_TXT_CARD_NUM_VALUE);

        private const string LABEL_GO_POOL_AREA = "CardArea/PoolArea";
        private GameObject m_PoolArea;
        protected GameObject PoolArea =>
            m_PoolArea = m_PoolArea != null ? m_PoolArea
            : Manager.GetNestedElement(LABEL_GO_POOL_AREA);

        private const string LABEL_IMG_ICON_OCG = "CardArea/IconOCG";
        private Image m_IconOCG;
        protected Image IconOCG =>
            m_IconOCG = m_IconOCG != null ? m_IconOCG
            : Manager.GetNestedElement<Image>(LABEL_IMG_ICON_OCG);

        private const string LABEL_IMG_ICON_TCG = "CardArea/IconTCG";
        private Image m_IconTCG;
        protected Image IconTCG =>
            m_IconTCG = m_IconTCG != null ? m_IconTCG
            : Manager.GetNestedElement<Image>(LABEL_IMG_ICON_TCG);

        private const string LABEL_IMG_ICON_SCCG = "CardArea/IconSCCG";
        private Image m_IconSCCG;
        protected Image IconSCCG =>
            m_IconSCCG = m_IconSCCG != null ? m_IconSCCG
            : Manager.GetNestedElement<Image>(LABEL_IMG_ICON_SCCG);

        private const string LABEL_IMG_ICON_DIY = "CardArea/IconDIY";
        private Image m_IconDIY;
        protected Image IconDIY =>
            m_IconDIY = m_IconDIY != null ? m_IconDIY
            : Manager.GetNestedElement<Image>(LABEL_IMG_ICON_DIY);

        private const string LABEL_IMG_ICON_RD = "CardArea/IconRD";
        private Image m_IconRD;
        protected Image IconRD =>
            m_IconRD = m_IconRD != null ? m_IconRD
            : Manager.GetNestedElement<Image>(LABEL_IMG_ICON_RD);

        private const string LABEL_IMG_ICON_PRE = "CardArea/IconPRE";
        private Image m_IconPRE;
        protected Image IconPRE =>
            m_IconPRE = m_IconPRE != null ? m_IconPRE
            : Manager.GetNestedElement<Image>(LABEL_IMG_ICON_PRE);
        ...
        protected override void Awake()
        {
            ...
            if (MenuArea != null)
            {
                ...
                ToggleBookMark.SetRightClickEvent(() =>
                {
                    Program.instance.deckEditor.GetUI<DeckEditorUI>().ShowBookmarkListSelection(Card.Id);
                });
        ...
        protected virtual void SetCardData(Card data)
        {
            ...
            if (TextArea != null)
            {
                TextArea.StopMovement();
                TextArea.verticalNormalizedPosition = 1f;
            }
            if (TextAreaPendulum != null)
            {
                TextAreaPendulum.StopMovement();
                TextAreaPendulum.verticalNormalizedPosition = 1f;
            }
        ...
        {
            if (Card == null || ToggleBookMark == null)
                return;
