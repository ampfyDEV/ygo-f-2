...
namespace MDPro3.Duel
{
    public class DuelBGManager
    {
        ...
        private OcgCore Core => DuelProvider.instance.ocgcore;
        private Deck deck;
        ...
        public async UniTask LoadAssetsAsync()
        {
            ...
            DuelProvider.instance.ocgcore.LoadDuelButton();
            await DuelProvider.instance.ocgcore.GetUI<OcgCoreUI>().LoadExtraUI();
